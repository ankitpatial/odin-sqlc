...
foreign pq {
	...
	setdb_login :: proc(host: cstring = nil, port: cstring = nil, options: cstring = nil, tty: cstring = nil, dbname: cstring = nil, login: cstring = nil, pwd: cstring = nil) -> Conn ---
	...
	exec_params :: proc(conn: Conn, command: cstring, n_params: i32, param_types: [^]OID, param_values: [^][^]byte, param_lengths: [^]i32, param_formats: [^]Format, result_format: Format) -> Result ---
	...
	exec_prepared :: proc(conn: Conn, stmt_name: cstring, n_params: i32, param_values: [^][^]byte, param_lengths: [^]i32, param_formats: [^]Format, result_format: Format) -> Result ---
	...
	send_query_params :: proc(conn: Conn, command: cstring, n_params: i32, param_types: [^]OID, param_values: [^][^]byte, param_lengths: [^]i32, param_formats: [^]Format, result_format: Format) -> b32 ---
	...
	send_query_prepared :: proc(conn: Conn, stmt_name: cstring, n_params: i32, param_values: [^][^]byte, param_lengths: [^]i32, param_formats: [^]Format, result_format: Format) -> b32 ---
